...
const table=(r,x,z,rotation=0)=>f('dining-compact','diningCompact',r,[x,z],[1.78,.98,1.2],rotation);
...
export const euro52=finishLayout({
 ...
 openings:[['entrance',8.4,3.65,1.05,['hall']],['door',5.04,3.15,.9,['hall','primary'],'Bedroom door',-1,true],['door',4.5,3.82,.9,['hall','living'],'Living room door',-1,true],['door',6.95,2.05,.9,['hall','bath1'],'Bathroom door',1],['door',6.95,4.5,.9,['hall','storage'],'Storage door',1,true],['door',1.25,2.5,.85,['primary','loggia1'],'Loggia door',1],['window',0,1.3,1.7,['loggia1']],['window',0,4.8,1.95,['living']]],
 furniture:[...bed('primary',3.45,1.3,0,'taupe',1.7,2.15,'walnut'),wardrobe('bed-wardrobe','primary',5.3,.7,1.1,-P/2,'dark'),sofa(1.14,3.75,2.1,0,'gray'),f('coffee-table','coffeeOval','living',[1.19,5.12],[1.7,.45,.68]),tv(1.19,6.24,1.8,P),kitchen('living',3.65,6.1,2.6,P),{...table('living',3,3.865),size:[1.55,.98,1.2]},wardrobe('hall-wardrobe','hall',8.03,2.8,1.2,-P/2,'dark'),wardrobe('store-shelves','storage',8.02,5.6,1.4,-P/2,'oak'),vanity('vanity1','bath1',6.25,.31,.85),shower('bath1',7.75,.6,1.05,1.0),wc('bath1',7.98,1.55,-P/2),plant('loggia1',.6,.4)],
...
export const classic78=finishLayout({
 ...
 furniture:[...bed('primary',1.4,1.675,P/2,'white',1.8,2.35),wardrobe('bed-wardrobe','primary',4.87,.95,1.45,-P/2),sofa(12.2,.65,2.7,0,'charcoal'),coffee(12.2,1.85),tv(12.2,3.04,2.8,P),f('accent-chair','chair','living',[10.3,.85],[.65,.95,.65],.65),plant('living',14.25,2.8),kitchen('kitchen',12.2,3.75,3.7),table('kitchen',12.45,5.685,P),tub('bath1',6.15,.45),vanity('vanity1','bath1',5.53,1.3,.7,P/2),wc('bath1',6.7,1.1,-P/2),vanity('vanity2','bath2',8,.3,.9),shower('bath2',9,.56,.95,.9),wc('bath2',9.18,1.47,-P/2),wardrobe('hall-storage','hall',7.42,4.55,1.2,P/2),plant('loggia1',15.3,6.0)],
...
export const euro70=finishLayout({
 ...
 furniture:[...bed('primary',1.92,1.35,0,'white',1.7,2.25),wardrobe('bed-wardrobe','primary',3.52,1.05,1.4,-P/2),...bed('bedroom2',7.02,8.25,P,'taupe',1.65,2.3,'darkMarble'),wardrobe('bedroom2-wardrobe','bedroom2',8.08,6.47,.75,-P/2,'oak'),sofa(4.92,6.65,2.35,-P/2),{...tv(1.29,7.3,1.16,P/2),position:[1.29,.5,7.3]},{...coffee(3.35,7.25),rotation:P/2},kitchen('living',2.62,4.09,2.7),{...table('living',1.715,5.82,P/2),size:[1.6,.98,1.2]},vanity('vanity1','bath1',4.48,.3,.8),shower('bath1',5.28,.72,.86,1.1),wc('bath1',4.27,1.65,P/2),vanity('vanity2','bath2',7.22,4.54,.65),shower('bath2',7.94,4.85,.75,1),wc('bath2',7.98,5.62,-P/2),wardrobe('storage-shelves','storage',8.1,2.15,2.15,-P/2,'oak')],
...
export const euro82=finishLayout({
 ...
 openings:[['entrance',1.93,0,1.05,['hall']],['door',1.25,2.35,.85,['hall','storage'],'Storage door',-1,true],['door',3.5,1.85,.9,['hall','bath1'],'Bathroom door',1],['door',4.85,2.6,.95,['hall','primary'],'Bedroom 01 door',1],['door',2.25,3.35,.85,['hall','bedroom2'],'Bedroom 02 door',-1],['door',3.65,3.35,.9,['hall','living'],'Living room door',-1],['door',1.65,4.6,.7,['bedroom2','bath2'],'En suite door',-1,true],['door',8.15,4.6,.9,['living','loggia1'],'Loggia door',1],['window',7.1,0,2.8,['primary']],['window',1.55,8.65,2.1,['bedroom2']],['window',5.7,7.4,2.8,['living']],['window',8.78,6.25,.95,['loggia1']]],
 furniture:[...bed('primary',8.05,1.675,-P/2,'white',1.7,2.3),wardrobe('bed-wardrobe','primary',5.17,.87,1.3,P/2),...bed('bedroom2',1.35,7.03,P/2,'taupe',1.65,2.25,'darkMarble'),wardrobe('bedroom2-wardrobe','bedroom2',2.77,5.95,.6,-P/2,'oak'),sofa(5.725,6.85,2.7,P),tv(7.84,6.15,1.95,-P/2),{...coffee(6.85,5.85),rotation:P/2},kitchen('living',6.12,3.74,3.05),{...table('living',3.765,5.55,P/2),size:[1.78,.98,1.1]},vanity('vanity1','bath1',3.25,.3,.85),shower('bath1',4.3,.55,.9,.85),wc('bath1',4.43,1.42,-P/2),vanity('vanity2','bath2',.42,4.15,.55),shower('bath2',.48,4.98,.78,.85,P/2),{...wc('bath2',1.22,5.12,P),size:[.43,.75,.6]},wardrobe('storage-shelves','storage',.3,2.1,1.6,P/2,'oak')],
...
export const classic106=finishLayout({
 ...
 furniture:[kitchen('kitchen',.42,2.6,3.7,P/2),f('breakfast','breakfast','kitchen',[2.385,2.7],[1.78,.98,1.2],-P/2),...bed('primary',5.35,2.2,-P/2,'white',1.8,2.3),wardrobe('bed-wardrobe','primary',3.43,1.15,1.5,P/2),...bed('bedroom2',1.25,12.5,P/2,'taupe',1.75,2.15,'padded'),wardrobe('bedroom2-wardrobe','bedroom2',2.77,10.2,1.0,-P/2,'dark'),f('dining','dining','living',[5.15,9.5],[2,.85,2.7]),sofa(6.05,12.5,2.55,-P/2,'light'),tv(3.41,12.5,2.5,P/2),coffee(4.75,12.5),f('hall-console','hallStorage','hall',[.33,7.05],[.85,2.15,.42],P/2),vanity('vanity1','bath1',5.1,5.86,.85),shower('bath1',6.1,6.13,1,1),wc('bath1',6.28,7.24,-P/2),vanity('vanity2','bath2',.42,8.64,.55),shower('bath2',1.2,9.74,.74,.78),wc('bath2',.42,9.78,P),plant('loggia1',2.67,-.6),plant('loggia2',.45,14.62)],
