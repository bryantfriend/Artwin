...
export const APARTMENT = {
  ...
  overview: { position: [24, 18, 12], target: [4.8, .5, 7.4] },
};
...
export const rooms = [
  ...
  { id: 'kitchen', name: 'Kitchen & dining', short: 'Kitchen', subtitle: 'Everyday rituals, beautifully framed', type: 'wood', polygon: rect(3.4,0,3,5.5), destination: [4.65,0.82,4.6], yaw: 0, label: [4.9,2.8] },
  ...
  { id: 'bath3', name: 'Bathroom', short: 'Bath 03', subtitle: 'A private retreat', type: 'stone', polygon: rect(0,7.5,2,1.9), destination: [1.45,0.82,8.45], yaw: Math.PI / 2, label: [1,8.45] },
...
export const furniture = [
  {id:'bed-north',kind:'bed',position:[1.25,0,1.75],rotation:0,size:[1.8,1.05,2.25],color:'linen'},
  {id:'bed-primary',kind:'bed',position:[1.5,0,12.9],rotation:Math.PI,size:[1.85,1.05,2.3],color:'taupe'},
  {id:'bed-south',kind:'bed',position:[4.75,0,12.8],rotation:Math.PI,size:[1.7,1.05,2.2],color:'sage'},
  {id:'nightstand-north',kind:'nightstand',position:[.28,0,.75],size:[.45,.55,.5]},
  {id:'nightstand-primary',kind:'nightstand',position:[.28,0,13.8],size:[.45,.55,.5]},
  {id:'nightstand-south',kind:'nightstand',position:[3.73,0,13.5],size:[.45,.55,.5]},
  ...
  {id:'hall-console',kind:'console',position:[3.35,0,7.35],size:[1.7,.88,.45]},
  {id:'kitchen-cabinets',kind:'kitchen',position:[6,0,2.25],rotation:Math.PI/2,size:[3.7,.92,.62]},
  {id:'dining',kind:'dining',position:[4.48,0,2.45],size:[1.25,.8,2.65]},
  {id:'sofa',kind:'sofa',position:[8.9,0,13.4],rotation:Math.PI/2,size:[2.75,.88,.95]},
  {id:'coffee-table',kind:'coffee',position:[7.55,0,13.35],size:[.7,.4,1.1]},
  {id:'tv-console',kind:'tv',position:[6.72,0,13.45],rotation:Math.PI/2,size:[2.05,.48,.38]},
  {id:'armchair',kind:'chair',position:[8.55,0,10.45],rotation:-.35,size:[.8,.85,.85]},
  ...
  {id:'toilet2',kind:'toilet',position:[.45,0,6.25],size:[.48,.7,.7]},
  {id:'vanity2',kind:'vanity',position:[.65,0,7.23],size:[.95,.85,.35]},
  {id:'shower',kind:'shower',position:[.48,0,8.02],size:[.8,2.1,.8]},
  {id:'vanity3',kind:'vanity',position:[.68,0,9.14],size:[1,.85,.35]},
  {id:'plant-living',kind:'plant',position:[9.2,0,15.25],size:[.5,1.5,.5]},
