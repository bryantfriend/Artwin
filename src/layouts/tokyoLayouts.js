...
export const euro52=finishLayout({
 ...
 furniture:[...bed('primary',3.45,1.3,0,'taupe',1.7,2.15,'walnut'),wardrobe('bed-wardrobe','primary',5.3,.7,1.1,-P/2,'dark'),sofa(1.25,3.75,2.1,0,'gray'),f('coffee-table','coffeeOval','living',[1.3,5.12],[1.7,.45,.68]),tv(1.3,6.24,1.8,P),kitchen('living',3.65,6.1,2.6,P),{...table('living',3.1,4.22),size:[1.35,.9,1.6]},wardrobe('hall-wardrobe','hall',8.03,2.8,1.2,-P/2,'dark'),wardrobe('store-shelves','storage',8.02,5.6,1.4,-P/2,'oak'),vanity('vanity1','bath1',6.25,.31,.85),shower('bath1',7.75,.6,1.05,1.0),wc('bath1',7.98,1.55,-P/2),plant('loggia1',.6,.4)],
...
export const euro82=finishLayout({
 ...
 furniture:[...bed('primary',8.05,1.675,-P/2,'white',1.7,2.3),wardrobe('bed-wardrobe','primary',5.17,.87,1.3,P/2),...bed('bedroom2',1.35,7.03,P/2,'taupe',1.65,2.25,'darkMarble'),wardrobe('bedroom2-wardrobe','bedroom2',2.77,5.95,.6,-P/2,'oak'),sofa(5.3,6.85,2.7,P),tv(7.84,6.15,1.95,-P/2),{...coffee(6.85,5.85),rotation:P/2},kitchen('living',6.12,3.74,3.05),table('living',4.8,4.95),vanity('vanity1','bath1',3.25,.3,.85),shower('bath1',4.3,.55,.9,.85),wc('bath1',4.43,1.42,-P/2),vanity('vanity2','bath2',.42,4.15,.55),shower('bath2',.48,4.98,.78,.85,P/2),{...wc('bath2',1.22,5.12,P),size:[.43,.75,.6]},wardrobe('storage-shelves','storage',.3,2.1,1.6,P/2,'oak')],
