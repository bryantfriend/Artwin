// Composed interior views, kept separate from collision-checked walking destinations.
export const tourStops=[
  {room:'living',title:'Space to come together',description:'An oval dining table, a generous sofa and a shared space for everyday life.',position:[7.1,1.72,10.2],target:[8.15,1.05,13.65],fov:68},
  {room:'kitchen',title:'Everyday rituals',description:'White marble, warm cabinetry and a breakfast table beside the loggia.',position:[4.65,1.7,4.8],target:[4.85,1.2,1.65],fov:72},
