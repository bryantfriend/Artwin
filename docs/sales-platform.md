...
8. A compact 2GIS location card with project lookup and shortcuts for schools, parks, clinics, shops and public transport. Links target Bishkek or Osh and use Russian local search terms regardless of the interface language. Nearby searches include the published address; no coordinates, nearby businesses or travel times are invented. Buyers choose their origin and transport in 2GIS. The page embeds no map, loads no third-party map scripts and does not collect a starting address.
