// Rebuild and run the production subpath server first. Writes six preview assets.
async (page) => {
  await page.goto('about:blank');
  await page.setViewportSize({width:1580,height:1050});
  for(const id of ['two-room-euro-52','three-room-euro-70','two-room-78','three-room-euro-82','three-room-106','four-room-134']) {
