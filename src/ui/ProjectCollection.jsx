...
export function CollectionFooter(){const {t}=useI18n();return <footer className="collection-footer"><div className="footer-identity"><span>ARTWIN <span className="footer-divider">/</span> {t('Spaces for living')}</span><p>{t('Project imagery & information from')} <a href={projectSource} target="_blank" rel="noopener noreferrer">{t('Artwin’s official collection')} ↗</a></p></div><SocialLinks/></footer>;}
