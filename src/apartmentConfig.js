...
export const furniture = [
  ...
  {id:'nightstand-north',kind:'nightstand',position:[.4,0,.35],size:[.45,.55,.5]},
  ...
  {id:'nightstand-north-2',kind:'nightstand',position:[.4,0,2.75],size:[.45,.55,.5]},
  ...
  {id:'shower',kind:'shower',position:[1.5,0,9],size:[.8,2.1,.65]},
